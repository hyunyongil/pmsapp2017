...
function Join()
{
	...
	this.loadForewardSkin = function()
	{
		...
		if (joinSurvey.surveyData.layoutDataMobile.template_cover_yn == "Y")
		{
            ...
            if(joinSurvey.surveyData.layoutDataMobile.cover_bg_user_path != "" && joinSurvey.surveyData.layoutDataMobile.template_cover == "0") {
                ...
                if(joinSurvey.surveyData.layoutDataMobile.cover_title_text_yn == "Y") {
                    foreward_html_c.push('        <h1 style="color:#ffffff; font-weight:bold; font-size:16px; text-align:center">'+joinSurvey.surveyData.layoutDataMobile.cover_title_text+'</h1>');
                }
    ...
    this.loadFooterSkin = function (pointMsg) {
        ...
        body_html.push('    <div class="end_template_div">');
        body_html.push('    	<div class="img_div"></div>');
                            ...
                            function () {
                                        ...
                                        $(this).append(DOM.getTr().append(
                                            function () {
                                                ...
                                                $(this).append(DOM.getTd().append(
                                                    function () {
                                                        var buogi_div_qst_type = "";
                                                        if (qstInfo.qstType == 'RANK') {
                                                            buogi_div_qst_type = " buogi_div2 buogi_div_rank_wrap";
                                                        }
                                                        else {
                                                            buogi_div_qst_type = " buogi_div buogi_div_rank_wrap";
                                                        }
                                                        ...
                                                        if (itemList[i].itemTitleImg != undefined && joinSurvey.htmlChecker(itemList[i].itemTitleImg)) {
                                                            ...
                                                            if(itemList[i].itemTitleImg.indexOf("<img") > -1 || itemList[i].itemTitleImg.indexOf("<iframe") > -1) {
                                                                $(this).append($(document.createElement('div')).addClass('muhang_text_border_img edit_div_img1').html("<label for='item"+i+"'>"+itemList[i].itemTitleImg+"</label>"));
                                                            }
                                                        }


                                                        $(this).append(DOM.getDiv(" chekbox_img_div "+buogi_div_qst_type).click(function(){
                                                            ...
                                                            function () {
                                                                $(this).append(
                                                                        ...
                                                                        function () {
                                                                            ...
                                                                            if (qstInfo.qstType == 'MULTI') {
                                                                                ...
                                                                                if (qstInfo.qstOptionList['ASKTYPE'].optionValue == 'MULTISELECT') //다중선택 처리
                                                                                {
                                                                                    ...
                                                                                    console.log('22');
                                                                                    $(this).append(
                                                                                        DOM.getCheckBox().attr({
                                                                                            'itemIndex': i,
                                                                                            'id': 'item' + i
                                                                                        }).val(itemList[i].itemSeq).on("change",function () {
                                                                                            console.log('22222');
                                                                                            //답변처리
                                                                    ...
                                                                    //								onpanel.printMsg('값을 '+subOptionValTmp[1]+'개 까지만 선택하여 주시기 바랍니다.', 'joinSurvey.focusQst('+grpSeq+', '+qstSeq+')');
                                                                                                    joinSurvey.askTypeCnt[qstInfo.qstSeq].cnt--;
                                                                                                    alert(' '+subOptionValTmp[1]+'개 까지만 선택하여 주시기 바랍니다.');
                                                                                ...
                                                                                else //단일선택 처리
                                                                                {
                                                                                    console.log('22-1');
                                                                                    $(this).append(
                                                                                        DOM.getRadioButton('item' + qstInfo.qstSeq).attr({
                                                                                            'itemIndex': i
                                                                                            , 'id': 'item' + i
                                                                                        }).val(itemList[i].itemSeq).on('change',function () {
                                                                                            console.log('33333');
                                                                                ...
                                                                                console.log('rank click start');
                                                                                $(this).append(
                                                                                    DOM.getCheckBox().on('change',function (e) {//랭크 선택시  처리
                                                                                        ...
                                                                                        if ($(this).prop('checked') == true)//빈박스 체크
                                                                                        {
                                                                                            ...
                                                                                            //$(this).parents('tr').addClass('buogi_on');
                                                                                            ...
                                                                                            //$(this).parents('tr').removeClass('buogi_on');
                                                                                        ...
                                                                                        'itemIndex': i,
                                                                                        'id': 'item' + i
                                                                                    }).val(itemList[i].itemSeq).on('change',function (e) {
                                                                                        console.log('aa-3');
                                ...
                                if (randLastVal == 'CHECKED') {
                                    ...
                                    $(this).append(
                                        ...
                                        DOM.getDiv(textLabel).addClass("chekbox_img_div buogi_div buogi_div_rank_wrap").append(
                                            function () {
                                                var i = continueItem;
                                                if (qstInfo.qstType == 'MULTI') {
                                        ...
                                        //								onpanel.printMsg('값을 '+subOptionValTmp[1]+'개 까지만 선택하여 주시기 바랍니다.', 'joinSurvey.focusQst('+grpSeq+', '+qstSeq+')');
                                                    ...
                                                    $(this).append(
                                                        ...
                                                        DOM.getCheckBox().on('click', function (e, param1) {
                                                            ...
                                                            'itemIndex': i,
                                                            'id': 'item' + i
                                                        }).val(itemList[i].itemSeq).change(function () {
                                                            //답변처리 //JUNE-0717
                                                            //joinSurvey.resultAsk(qstInfo, 'MULTI', $(this));
                                                            if (typeof checkSelectCnt == 'undefined') {
                                                                checkSelectCnt = 1;
...
//console.log(qstInfo.qstType);
        var rankLabel="";
        var label_tag="";
        if(qstInfo.qstType == 'RANK' || qstInfo.qstType == 'MULTI'){
...
//console.log(i);
		...
		var returnObj =
            $(document.createElement(label_tag)).attr('for', 'item'+i).addClass(rankLabel).append(
                function()
                {
                    ...
                    // 원래 이미지 삽입하는 코드는 여기 있었음
                    //답변 이미지/동영상 그리기
                    //if(itemList[i].itemTitleImg != undefined && joinSurvey.htmlChecker(itemList[i].itemTitleImg))
                    //{
                    //    DOM.getImage(itemList[i].itemTitleImg).css({'padding-top':'7px'});
                    //    $(this).append($(document.createElement('div')).addClass('muhang_text_border_img edit_div_img1').html(itemList[i].itemTitleImg));
                    //}

                    if(itemList[i].itemOptionList['INPUT'].optionValue == 'CHECKED')//기타 input box
                    {
                        $(this).append(
                                DOM.getDiv('ui-block-a').css({'width':'auto', 'line-height':'22px','margin-right':'15px'}).append(itemList[i].itemTitle)
                        ).attr("style",joinSurvey.surveyData.layoutDataMobile.body_font_view);
                    }
                ...
                function()
                {
                    ...
                    if(itemList[i].itemOptionList['INPUT'].optionValue != 'CHECKED')//기타 input box
                    {
                        $(this).append(itemList[i].itemTitle)
                    }
                }
            )
...
//console.log(i);
    		...
    		if( qstInfo.qstType == 'MULTI' && qstInfo.qstOptionList['ASKTYPE'].optionValue == 'MULTISELECT')//체크박스, 다중선택
    		{
        		returnObj =
                            ...
                            DOM.getTextBox().css({'margin-left':'10px', 'margin-top':'5px'}).click(function(){
                                ...
                                $(this).parent().parent().parent().parent().find('input[type="checkbox"]').trigger('click');
                                console.log('a2');
        					...
        					//$(this).append(
                                DOM.getTextBox().css({'margin-left':'10px', 'margin-top':'5px'}).click(function(){
                                    ...
                                    joinSurvey.resultAsk(qstInfo, '', this, '', 'etc');
                                        ...
                                        {
                                          //$(this).parent().parent().parent().parent().find('input:first').prop('checked', true).checkboxradio("refresh");
                                          $(this).parent().parent().parent().parent().find('input[type="radio"]').trigger('click');
                                          //$(this).parent().parent().parent().parent().find('input:first').trigger('click');//???
                                        }else{//우선순위
            ...
            $(document.createElement('label')).attr('for', 'item'+continueItem).addClass(rankLabel).append(
				function()
				{
                    ...
                    if(lastItem.itemTitleImg != undefined && joinSurvey.htmlChecker(lastItem.itemTitleImg))
                    {
                        ...
                        $(this).append($(document.createElement('div')).addClass('muhang_text_border_img edit_div_img1').html(lastItem.itemTitleImg));
	...
	{
        console.log('randomExceptionSub');
		var lastItem = end(qstInfo.itemList);
		var itemList = JSON.parse(JSON.stringify(qstInfo.itemList));
        var returnObj = '';
					...
					for(var i in qstInfo.sectionList)
					{
    				    $(this).append(
            				DOM.getTable().addClass('poll_table'+' basic_table '+joinSurvey.surveyData.layoutDataMobile.body_table_type+' table_size2').attr({'width':tableWidth,'style':'','scope':'row'}).append(//table
            					DOM.getTr().append(
            							$(document.createElement('th')).attr({'rowspan':'2','style':'','scope':'row'}).html('구분')
            					).append(
            						function()
            						{
            							//단을 그림
			...
			DOM.getTable().addClass('poll_table'+' basic_table '+joinSurvey.surveyData.layoutDataMobile.body_table_type+' ').attr({'width':'100%'}).append(
				DOM.getTr().append(
					...
					function()
					{
						...
						{
                            $(this).append(
                                $(document.createElement('th')).attr({'style':'','scope':'row'}).html(qstInfo.sectionList[i].itemList[0].itemTitle)
                            );
							$(this).append(
                            ...
                            $(this).append(
                                $(document.createElement('th')).attr({'scope':'row'}).html(qstInfo.sectionList[i].itemList[1].itemTitle)
                            );
						}
					}
				)
                                ...
                                $(document.createElement('div')).append(DOM.getTable().addClass('poll_table'+' basic_table '+joinSurvey.surveyData.layoutDataMobile.body_table_type+' table_size1').attr({'width':tableWidth}).append(
                                    DOM.getTr().append(
                                        ...
                                        function()
                                        {
                                            // 단제목
                                            $(this).append(
                                                $(document.createElement('th')).attr({'colspan':qstInfo.sectionList[i].itemList.length}).append(
                                    ...
                                    DOM.getTr().append(//맨 좌측 th
                                        function()
                                        {
                                            ...
                                            //{
                                                $(this).append(
                                                    $(document.createElement('th')).attr({'scope':'row'}).addClass('').append(
                                                        DOM.getDiv()
                                                        .css({'margin':'0 auto'})
                                                ...
                                                $(this).append(
                                                    $('<tr>').append(
                                                        $('<td>').html(function () {
                                                            ...
                                                            $('<div>').append(
                                                                $('<ul>').append(
                                                                    $('<li>').append($('<span>').addClass('text_text_margin_right').text(qstInfo.subQstList[qi].qstTitle)).append(
                                                                        function () {
                                                            ...
                                                            //for (var j in qstInfo.sectionList) {
                                                                if (qstInfo.sectionList[i].sectionOptionList['INPUTTYPE'].optionValue == 'SELECT') {
                                                                    //for (var k in qstInfo.sectionList[i].itemList) {
                                                                        $(this).append(
                                                                            $(document.createElement('td')).attr({'align': 'center'}).append(
                                                                                $('<select>').addClass('table_input_03').append(
                                                                                    function () {
                                                                                        $(this).append(
...
//								$(document.createElement('td')).attr({'style':joinSurvey.surveyData.layoutDataNew.body_font_table}).append(
                                DOM.getDiv().append(
                                    $(document.createElement('ul')).append(
                                        $(document.createElement('li')).append($('<span>').addClass('text_text_margin_right').text(qstInfo.subQstList[i].qstTitle)).append(
                                            function () {
					...
					for(var i in qstInfo.sectionList)
					{
    				    $(this).append(
                			...
                			DOM.getTable().addClass('poll_table' + ' basic_table ' + joinSurvey.surveyData.layoutDataMobile.body_table_type + ' table_size4').attr({'width':tableWidth}).append(
                				DOM.getTr().append(
                					$(document.createElement('th')).attr({'rowspan':'2','style':''}).html('구분')
                				).append(
                					function()
                					{
                						//단을 그림table_border_left
                								...
                								function()
                								{
                									...
                									//{
                										...
                										else
                										{
                											...
                											{
                												$(this).append(
                													$(document.createElement('td')).attr({'align':'center'}).css("width",tdWidthPer+"%").addClass('poll_table_multi_radio').append(
                				                                        DOM.getTable().append(//라디오버튼 가로정렬위한 테이블
                                                                            DOM.getTr().append(
                        														function()
                        														{
...
console.log('a3:'+etcOption)
            ...
            {
                console.log('a3-3333');
                //subAddResponse = askItemSeq;

                console.log(qstInfo.itemList);
...
console.log('subAddResponse1:'+subAddResponse)
            ...
            console.log($formId.prop('checked'));
...
console.log(joinSurvey.joinData.grpList[grpSeq].qstList[qstSeq].askList);
						...
						for(var i in joinSurvey.joinData.grpList[grpSeq].qstList[qstSeq].askList)
						{
                            ...
                            console.log(qstInfo.itemList);
    							...
    							{
                                    console.log(joinSurvey.joinData);
                                    console.log(joinSurvey.joinData.grpList[grpSeq].qstList[qstSeq].askList[i].subAddResponse);
    								if(joinSurvey.joinData.grpList[grpSeq].qstList[qstSeq].askList[i].subAddResponse == '')
    								{
    //									onpanel.printMsg('답변을 입력하여 주시기 바랍니다.', 'joinSurvey.focusQst('+grpSeq+', '+qstSeq+')');
