$(document).one('pageinit', '#findMemberPw_page', function () {
    ...
    page.model = ( function () {
        ...
        pri.findPwdArgs = {
            url: CONSTANTS.MEMBER.FIND_PWD_NEW,
            type: CONSTANTS.METHOD.POST
        };
    ...
    page.view = ( function () {
        ...
        pri.findCallback = function (data) {
            ...
            if (ONPANEL.Ajax.Result.isSucess(data)) {
                COMMON.storage.put('member_id',pri.memberId.val());
                COMMON.storage.put('new_password',data.result.key);
                location.href = "findMemberPwResultNew.html"
            }
            else {
