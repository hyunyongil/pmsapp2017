...
$(document).one('pageinit', '#home_page', function () {
    ...
    page.controller = ( function () {
        ...
        pub.init = function () {
            ...
            $(document).on('click','.home_list li', function (event, ui) {
                ...
                if (firstYN == "Y") {
                    if (type == "reserch") {
                        document.location.href = "poll_join_new.html?surveySeq="+number;
                    }else if(type == "reserchEnd"){
						alertLayer('이미 참여하신 설문입니다.');
					}else {
                        document.location.href = "onpoll.html?poll_num="+number;
                        // document.location.href = "onpoll.html";
                    }
                } else if (firstYN == "N") {
                    document.location.href = "firstPoll.html";
                }
