$(document).one('pageinit', '#findMemberIdResult_page', function () {
    ...
    page.model = ( function () {
        ...
        pub.getMemberIdArgs = pri.getMemberIdArgs;
    ...
    page.view = ( function () {
        ...
        // private functions
        // ////////////////////////////
        pri.loadMemeberIdCallback = function (data) {
            console.log(data);

            if (ONPANEL.Ajax.Result.isSucess(data)) {
                pri.memberId.text(data.result.member_id);
            } else {
        ...
        pub.loadMemeberIdCallback = pri.loadMemeberIdCallback;
    ...
    page.controller = ( function () {
        ...
        pri.loadMemeberId = function () {
            pri.getMemeberId(page.view.loadMemeberIdCallback);
        };
